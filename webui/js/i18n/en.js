...
window.I18N_EN = {
  ...
  "wizard.mode_selection_desc": "Choose the operating mode.",
  "wizard.tooltip.replication_min": "Minimum number of model instances across backends (for parallel requests). 0 = replication disabled.",
  "wizard.tooltip.replication_max": "Maximum number of instances. When load exceeds capacity, new replicas spin up to this limit.",
  "wizard.tooltip.replication_idle_unload": "How long to keep an idle replica before unloading. Format: 10m, 30m, 1h, 2h.",
  "wizard.tooltip.rpc_url": "URL of external RPC coordinator (e.g., http://coordinator:8080). Balancer will proxy inference requests through it.",
  "wizard.tooltip.rpc_worker_port": "Port where workers listen for commands from coordinator. Must match across all workers.",
  "wizard.tooltip.rpc_protocol": "Protocol for worker communication. HTTP — simple, gRPC — faster for streaming.",
  "wizard.tooltip.rpc_timeout": "Timeout for worker response. Format: 30s, 60s, 2m.",
  "wizard.tooltip.rpc_max_retries": "How many times to retry a request when worker fails (timeout, connection refused).",
  "wizard.tooltip.virtual_coord_mode": "Sequential — slices run in chain. Parallel — concurrently. Tree — hierarchically (parent → children).",
  "wizard.tooltip.virtual_timeout": "Timeout for virtual model request (ms). Higher = more stable on long pipelines.",
  "wizard.tooltip.dist_grpc_port": "gRPC server port for custom distributed inference. Requires your own proxy/coord code.",
  "wizard.tooltip.balancing_algorithm": "Resource-Aware considers GPU/CPU/VRAM. Least Connections — minimum active requests. Round Robin — in turn. Weighted — by weights. Model Affinity — tries to route to backend with already-loaded model.",
  "wizard.tooltip.gpu_max": "Maximum GPU utilization (%) before balancer routes to another backend. 100 = full load OK.",
  "wizard.tooltip.vram_max": "Maximum VRAM usage (%) before balancer routes to another backend. Leave 5-10% margin for KV cache.",
  "wizard.tooltip.cpu_max": "Maximum CPU utilization (%) before routing to another backend.",
  "wizard.tooltip.ram_max": "Maximum RAM usage (%). Note that cppworker uses RAM for model mmap.",
  "wizard.tooltip.api_token": "Token for WebUI → balancer → cppworker auth. Must match API_TOKEN in docker-compose. Change if default doesn't suit you.",
  "wizard.summary_empty": "No parameters for this mode.",
  "wizard.gpu_max_label": "GPU Max %",
  "wizard.vram_max_label": "VRAM Max %",
  "wizard.cpu_max_label": "CPU Max %",
  "wizard.ram_max_label": "RAM Max %",
  "wizard.api_token_label": "API Token",
  ...
  "wizard.hardware_preset": "Hardware preset",
  "wizard.tooltip.hardware_preset": "Apply tuned defaults for your GPU. For cppworker parameters (n_ctx, gpu_layers, etc.) see the hint below.",
  "gguf.total_backends": "Backends",
  ...
  "gguf.searching_for": "Searching for \"{q}\"...",
  "gguf.search_results": "Search Results",
  "gguf.no_results": "No results found",
  "gguf.no_results_for": "No results for \"{q}\"",
  "gguf.try_short_query": "Try a shorter query, e.g. \"Qwen\", \"Llama-3\", \"gemma-2-9b\"",
  "gguf.no_gguf_files_hint": "Repository exists but contains no .gguf files (GGUF may be in another repo or branch).",
  "gguf.results_count": "{n} models",
  "gguf.search_title": "HuggingFace Hub",
  "gguf.search_hint": "Type 2+ chars to search, or paste an org/model id (with \"/\") to jump straight to its files.",
  "gguf.popular": "Popular",
  "gguf.direct_link": "Or paste org/model id",
  ...
  "gguf.download_history": "Download history",
  ...
  "gguf.presets_label": "Presets:",
  "gguf.preset_speed": "⚡ Max Speed",
  "gguf.preset_memory": "💾 Max VRAM Save",
  "gguf.preset_context": "📖 Large Context",
  "gguf.preset_cpu": "🖥 CPU-only",
  "gguf.preset_applied": "Preset applied:",
  "gguf.flash_attn_desc": "Enable Flash Attention (memory O(n) instead of O(n²)). Recommended — speeds up long contexts.",
  "gguf.numa_desc": "Non-Uniform Memory Access. Enable only on NUMA systems (multi-socket servers). On desktop usually 0.",
  "gguf.use_mmap_desc": "Memory-map the model file instead of loading into RAM. Saves RAM but slows cold-start. Recommended true.",
  "gguf.strategy_desc": "How to distribute model layers between GPUs. vram-ratio (by memory) — auto. Manual — set ratios yourself. Auto — let llama.cpp decide.",
  "gguf.auto_gpu_distribution_desc": "Auto-compute optimal tensor split based on free VRAM. Convenient for mixed-GPU.",
  "gguf.rpc_backend_desc": "RPC backend for distributed compute (cuda/vulkan/kompute). Leave default if model is on single backend.",
  "gguf.rope_scaling_type_desc": "Context extension method: none (standard), linear (linear extrapolation), yarn (smart extension for long contexts).",
  "gguf.yarn_ext_factor_desc": "YaRN extrapolation factor. Higher = more aggressive extension, higher risk of hallucinations. Standard: 1.0.",
  "gguf.yarn_attn_factor_desc": "YaRN attention factor. Standard: 1.0. Decrease if model loses focus on long contexts.",
  "gguf.yarn_beta_fast_desc": "YaRN beta-fast parameter. Standard: 32. Lower = more aggressive attention to old tokens.",
  "gguf.yarn_beta_slow_desc": "YaRN beta-slow parameter. Standard: 1. Lower = more aggressive attention to new tokens.",
  "gguf.enable_metrics_desc": "Enable Prometheus-style metrics (tokens/sec, latency, queue depth). Visible in Monitor page.",
  "gguf.metrics_retention_desc": "How many seconds to keep metrics in memory. 0 = keep forever. Default 3600 (1 hour).",
  "gguf.tab_reasoning": "Reasoning / Thinking",
  "gguf.enable_reasoning": "Enable Reasoning",
  "gguf.enable_reasoning_desc": "Enables thinking mode for models that support it (gemma-4, deepseek-r1, qwen3-thinking). Parser will automatically extract think-blocks into a separate reasoning_content field.",
  "gguf.reasoning_budget": "Reasoning Token Budget",
  ...
  "gguf.cancelled_short": "cancelled",
  // R65d (2026-09-20): ключи, которые запрашивал UI, но которых не было в
  // словаре. I18N.t() молча возвращал undefined, поэтому в тостах и кнопках
  // показывался сырой ключ ("gguf.confirm_delete_model") либо английский
  // fallback из кода. Регрессия зафиксирована в webui/tests/test_gguf_api_headers.js.
  "gguf.confirm_delete_model": "Delete this model file from disk? This cannot be undone.",
  "gguf.model_deleted": "Model deleted",
  "gguf.delete": "Delete",
  "gguf.hf_query_too_short": "Search query is too short — enter at least 2 characters.",
  "gguf.download_started": "Download started",
  "gguf.partial_download_resumable": "Partial download found — it can be resumed.",
  "gguf.already_downloaded": "This file is already downloaded.",
  "gguf.resume_download": "Resume download",
  "gguf.n_parallel": "Parallel sequences (n_parallel)",
  "gguf.n_parallel_desc": "Default parallel slots per model. 0 = inherit cppworker default (1, sequential), 1..8 = multi-slot KV-cache isolation. > 1 = more VRAM (KV-cache × parallel) and faster concurrent throughput.",
  ...
  "gguf.strategy_auto": "Auto (llama.cpp decides)",
  ...
  "gguf.gpu_layers_badge_auto":   "AUTO",
  "gguf.gpu_layers_badge_all":    "All",
  "gguf.gpu_layers_badge_cpu":    "CPU",
  "gguf.gpu_layers_badge_custom": "{n} layers",
  "gguf.gpu_layers_btn_auto":     "AUTO (-2)",
  "gguf.gpu_layers_btn_all":      "All layers (-1)",
  "gguf.gpu_layers_btn_cpu":      "CPU only (0)",
  "gguf.gpu_layers_recommended":  "AUTO is recommended for most cases.",
  ...
  "gguf.delete_from_disk": "Delete downloaded file from disk",
  "gguf.confirm_delete": "Delete this model file from disk? This action cannot be undone.",
  "gguf.confirm_delete_file": "Delete {name} from disk? Partial .download file will also be removed.",
  "gguf.file_deleted": "File deleted",
  "gguf.file_not_found": "File not found (already deleted?)",
  "gguf.disk_freed": "Disk freed: {size}",
  "gguf.cleanup_failed_downloads": "Clear failed downloads",
  "gguf.cleanup_failed_downloads_hint": "Remove partial .download files left over from interrupted downloads.",
  "gguf.residual_downloads": "Residual files (orphans)",
  "gguf.orphans_hint": "Partial .download files left from interrupted downloads. They take disk space but are not associated with any active download.",
  "gguf.cleanup_all_orphans": "Clear all residual files",
  "gguf.confirm_cleanup_all_orphans": "Delete {count} residual files ({size})? This will free disk space but cannot be undone.",
  "gguf.no_orphans_to_cleanup": "No residual files",
  ...
  "gguf.unload_busy": "Cannot unload: model is busy with active inference requests.",
  ...
  "settings.profiles.timeout_help": "0 = auto (3-tier resolver: per-model profile → stats from history → heuristic by GGUF size → global config). After the 1st successful generation, auto-tune takes over and replaces the heuristic. > 0 overrides for this model only.",
  "settings.profiles.reasoning_mode": "Reasoning mode (×3 timeout for thinking models)",
  "settings.profiles.reasoning_mode_help": "Enable for reasoning-capable models (gemma-4, Qwen3-Instruct with thinking): the heuristic timeout is automatically multiplied by 3 (e.g., 900s → 2700s). Don't touch the fields below — they will be filled automatically. You can override manually later.",
  ...
  // ===== Extended parameters (Session 17, 2026-07-27) =====
  "gguf.tab_general": "General",
  "gguf.tab_multi_gpu": "Multi-GPU and distribution",
  "gguf.tab_kv_cache": "KV-cache",
  "gguf.tab_rope_yarn": "RoPE and YaRN (context extension)",
  "gguf.tab_perf": "Performance and metrics",
  "gguf.tab_inference": "Inference (parallel + reasoning)",
  "gguf.use_mlock": "Use MLOCK",
  "gguf.use_mlock_desc": "Lock model pages in RAM (no swap). Requires CAP_IPC_LOCK.",
  "gguf.split_mode": "Split mode",
  "gguf.split_mode_desc": "-1=default, 0=NONE, 1=LAYER, 2=ROW, 3=TENSOR.",
  "gguf.main_gpu": "Main GPU",
  "gguf.main_gpu_desc": "GPU index for buffers that don't fit the split. 0 = first card.",
  "gguf.rpc_backend": "RPC Backend",
  "gguf.no_memory_map": "No mmap",
  "gguf.no_memory_map_desc": "Fully load model into RAM (no mmap). Rarely needed.",
  "gguf.kv_cache_type": "KV-cache quantization",
  "gguf.kv_cache_type_desc": "q8_0 saves ~50% VRAM, q4_0 ~75%.",
  "gguf.no_kv_offload": "No KV offload",
  "gguf.no_kv_offload_desc": "Keep KV-cache in RAM (don't offload to GPU). Slows inference heavily.",
  "gguf.rope_freq_base": "RoPE Frequency Base",
  "gguf.rope_freq_base_desc": "RoPE base frequency. Default: 10000. For LLaMA-3 / gemma: 500000+.",
  "gguf.rope_freq_scale": "RoPE Frequency Scale",
  "gguf.rope_freq_scale_desc": "RoPE frequency multiplier. Default: 1.0.",
  "gguf.rope_scaling_type": "RoPE Scaling Type",
  "gguf.rope_scaling_factor": "RoPE Scaling Factor",
  "gguf.rope_scaling_factor_desc": "Multiplier for RoPE scaling. Default: 1.0. For YaRN: 4-32. Higher = longer effective context.",
  ...
  "gguf.rms_norm_eps_desc": "Epsilon for RMS normalization. Default: 1e-5.",
  "gguf.idle_unload_minutes": "Idle unload (min)",
  "gguf.idle_unload_desc": "Auto-unload model from VRAM after N minutes idle. 0 = off.",
  "gguf.enable_metrics": "Enable metrics",
  "gguf.metrics_retention": "Metrics retention (sec)",
  // ===== Runtime Overrides (Session 17, 2026-07-27) =====
  "gguf.overrides_active": "Runtime overrides active",
  "gguf.overrides_path": "/app/data/runtime-overrides/llama-cpp.json",
  "gguf.overrides_desc": "Current values differ from config.json (host = source of truth). Changes are saved in a sidecar file and survive container restarts. \"Reset\" removes the override and reverts to config.json values.",
  "gguf.reset_to_bundled": "Reset to bundled defaults",
  "gguf.overrides_confirm_reset": "Reset runtime overrides? llamaCpp will revert to bundled defaults from config.json.",
  "gguf.overrides_reset_done": "Runtime overrides cleared. llamaCpp reverted to bundled defaults.",
