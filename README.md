...
> **🚦 Быстрый старт** (новое железо или миграция): см. [docs/ru/hardware-presets.md](docs/ru/hardware-presets.md) — 4 готовых пресета для RTX 30xx/40xx/50xx и A10. Скрипт `python scripts/apply-hardware-preset.py <name>` за 30 секунд правит `.env.bundled-with-agent` под вашу GPU.
