...
|------|------|--------|--------|
| (нет активных WIP) | — | — | ✅ Все фазы B1–B8 завершены |
...
| **2026-Q3** | **Roadmap to 1.0 — реализация R-5 (cocoindex для llama_cpp)** — все B-фазы B1–B8 + R-1..R-4, R-6, R-7 уже DONE в Sessions 1–12 |
